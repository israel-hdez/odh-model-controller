...
// +kubebuilder:webhook:path=/mutate-serving-kserve-io-v1alpha1-inferencegraph,mutating=true,failurePolicy=fail,sideEffects=None,groups=serving.kserve.io,resources=inferencegraphs,verbs=create;update,versions=v1alpha1,name=minferencegraph-v1alpha1.kb.io,admissionReviewVersions=v1
...
func (d *InferenceGraphCustomDefaulter) Default(ctx context.Context, obj runtime.Object) error {
	...
	err := serving.ApplyDefaultServerlessAnnotations(ctx, d.client, inferencegraph.GetName(), inferencegraph.GetAnnotations(), logger)
	if err != nil {
		return err
	}
